import swooshHero from "../../shared/assets/image/swoosh-hero.png";
        ...
        <div className="flex flex-col items-center lg:items-start">
          <div className="flex items-center space-x-4">
            <Image
              ...
              src={airbnbLogo}
              alt="Airbnb Logo"
              className="h-12 sm:h-14 md:h-16 lg:h-20 w-12 sm:w-14 md:w-16 lg:w-20"
            />
            <h1
              className="text-5xl sm:text-6xl md:text-7xl lg:text-8xl font-bold  text-[#FE6B6E] "
              data-aos="fade-up"
              data-aos-duration="1000"
            >
              airbnb
